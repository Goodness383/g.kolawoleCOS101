fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to train Electrical/Electronic
        engineering professionals in the areas of design, building and maintenanace
        of Electrical control system,",n4 );
    ...
    println!("{} is aimed at developing competent, creative, innovative, entrepreneurial
        and ethnically-minded persons, Computer Science. ",w3 );

fn main() {
    ...
    //create a slice of the second and the third elment
    ...
    //This means the slice starts from index and goes up to index 5(exclusive)
    ...
    let slice4=&numbers[..];
    //This means the slice starts from index 0 and goes up to index 5(exlcusive).
